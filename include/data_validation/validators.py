...
class DataValidator:
    ...
    # Validate schema of the dataframe
    ...
    # Returns a report dictionary with statistics and issues
    ...
    # Helper method to detect outliers using IQR or Z-score
    # Returns the count of outliers
    ...
    # Returns a DataFrameSchema object
    ...
    # Returns a report dictionary with time series issues
    ...
    # Validate prediction data against training stats
    # Returns a tuple of (is_valid: bool, errors: List[str])
